    ...
    return (
        <div className="min-h-screen px-4 py-4 md:px-8 md:py-8">
            <div className="neo-shell dashboard-shell min-h-[calc(100vh-2rem)] p-3 md:p-4">
                <div className="grid gap-3 md:grid-cols-[58px_1fr]">
                    <aside className="neo-panel flex min-h-[calc(100vh-4.5rem)] flex-col items-center justify-between py-5">
                        <div className="space-y-2">
                            <button type="button" className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-[#171b2d] text-white">
                                <Plus className="h-4 w-4" />
                            </button>
                            <button type="button" className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-[#E2E7F1] bg-white text-slate-500">
                    ...
                    <div className="neo-panel min-h-[calc(100vh-4.5rem)] p-4 md:p-6">
                        ...
                        <main className="px-2 pb-6 pt-8 md:px-6 md:pt-12">
                            <p className="text-[11px] font-semibold uppercase tracking-[0.1em] text-slate-500">From first idea to published reply</p>
                            ...
                            <div className="mt-8 grid gap-4 md:grid-cols-3">
                                {featureCards.map((card) => (
                                    <Card key={card.title} className="min-h-[230px] p-5">
