...
export function RegisterForm() {
    ...
    return (
        <form className="space-y-4" onSubmit={onSubmit}>
            ...
            <div>
                <label className="mb-1.5 block text-[13px] font-semibold text-primary-text">Nombre completo</label>
                <input
                    value={name}
            ...
            <p className="text-center text-[14px] text-secondary-text pt-4">
                ¿Ya tienes una cuenta? <Link className="font-semibold text-primary-dark hover:text-accent-blue transition-colors" href="/login">Inicia sesión</Link>
            </p>
        </form>
    )
}
