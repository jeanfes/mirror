...
export function HistoryFilters({
    ...
    return (
        <div className="rounded-[28px] border border-white/70 bg-[linear-gradient(180deg,rgba(255,255,255,0.88),rgba(246,248,252,0.88))] p-5 shadow-[0_24px_70px_rgba(15,23,42,0.08)] backdrop-blur-xl">
            <div className="flex flex-col gap-4 border-b border-[#E8ECF4] pb-4 md:flex-row md:items-end md:justify-between">
                <div>
                    <span className="inline-flex items-center gap-2 rounded-full border border-[#E7DBFF] bg-[#F7F1FF] px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.12em] text-[#6D28D9]">
                        <SlidersHorizontal className="h-3.5 w-3.5" />
                        Workbench filters
                    </span>
                    <h2 className="mt-3 text-[20px] font-semibold tracking-[-0.03em] text-[#141824]">Review outputs with context, not noise.</h2>
                ...
                <div className="flex flex-wrap items-center gap-2 text-[12px] font-semibold text-slate-600">
                    <span className="rounded-full border border-[#E6EAF2] bg-white px-3 py-1.5">
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="h-12 w-full rounded-2xl border border-[#E6EAF2] bg-white pl-10 pr-3 text-[14px] text-[#141824] outline-none focus:ring-2 focus:ring-[#8B5CF6]/30"
                        />
                    </div>
                </div>
            ...
            <div className="mt-4 flex flex-wrap items-center gap-2 border-t border-[#E8ECF4] pt-4">
