    ...
    return (
        <section id="features" className="w-full py-24 pb-32 relative z-10">
            <div className="mx-auto max-w-6xl px-6">
                ...
                >
                    <div className="neo-card relative overflow-visible rounded-[18px] border border-border-light bg-surface-card backdrop-blur-sm p-10 shadow-premium-sm group transition-all duration-300 hover:-translate-y-2 hover:shadow-premium-md">
