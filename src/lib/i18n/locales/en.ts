const en = {
  ...
  contactPage: {
    ...
    submitError: "We could not send your message right now. Please try again in a few minutes.",
    errors: {
  ...
  app: {
    common: {
      ...
      notFoundDesc: "The route you requested does not exist in this workspace or you might not have access.",
      notFoundGoToApp: "Go to Mirror",
      notFoundGoToLanding: "Go to landing",
      metadataDescription: "Smart workspace with local-first AI.",
    ...
    billing: {
      ...
      creditTransactionsDesc: "Recent credit movements tracked for this account.",
      planChanges: "Plan changes",
      planChangesDesc: "History of upgrades, cancellations, and downgrades.",
      billingSnapshot: "Billing snapshot",
      billingSnapshotDesc: "Generations recorded this month.",
      creditTransactionsEmptyTitle: "No credit transactions yet",
      creditTransactionsEmptyDesc: "Credit usage and refills will appear here.",
      planChangesEmptyTitle: "No plan changes yet",
      planChangesEmptyDesc: "Transitions between Free and Pro will appear here.",
      creditDate: "Date",
      creditDelta: "Delta",
    ...
    onboardingProfessional: {
      badge: "Onboarding",
      title: "Tell us who you are professionally",
      description: "This helps Mirror understand your context and generate replies that sound more like you.",
      question: "What do you do, and what do you want to achieve with your online presence?",
      helper: "Keep it short if you want. Focus on your role, audience, and the positioning you want to build.",
      placeholder: "e.g. I'm a freelance growth marketer working with B2B startups in LATAM, and I want to position myself as a trusted expert without sounding salesy.",
      skipAction: "Skip for now",
      continueAction: "Save and continue",
      continueWithoutBio: "Continue without bio",
      savedToast: "Professional profile saved",
      firstProfileTitle: "Before creating your first profile",
      firstProfileDesc: "Tell us briefly who you are. This helps the AI understand you better."
    },
    settings: {
      heroTitle: "Settings",
      ...
      languageBaselineTitle: "Language and active profile",
      ...
      labelFr: "Français",
      labelDe: "German",
      personaBioTitle: "Who are you?",
      personaBioDesc: "Your professional bio helps Mirror generate answers that sound more like you.",
      personaBioPlaceholder: "e.g. Founder at B2B SaaS, sales expert and AI enthusiast..."
    },
    goals: {
      title: "Goals",
      ...
      strategyPromptPlaceholder: "Strategy prompt (how this objective should write by default)",
      baseObjectiveNames: {
      ...
      baseObjectiveDescriptions: {
        "base-linkedin-job-search": "Build credibility to attract job opportunities.",
        "base-linkedin-networking": "Start authentic professional conversations and grow your network.",
        "base-linkedin-authority": "Share practical insights that reinforce your authority.",
        "base-linkedin-conversation": "Open the conversation with a clear and natural prompt.",
        "base-linkedin-followup": "Move the conversation forward with a concrete next step.",
        "base-upwork-proposal": "Present fit, approach, and expected outcome in a concise proposal.",
        "base-upwork-scope-discovery": "Clarify scope, constraints, and success criteria early.",
        "base-upwork-value-diff": "Highlight what makes your approach different and valuable.",
        "base-upwork-close-cta": "Close with a concrete next action to keep momentum.",
        "base-upwork-objections": "Handle objections with evidence, calm tone, and options.",
        "base-twitter-hot-take": "Offer a constructive counterpoint without escalating tone.",
        "base-twitter-thread-value": "Add one concrete insight that advances the thread.",
        "base-reddit-context-help": "Answer with context and practical help for the original question.",
        "base-reddit-question": "Ask a clarifying question that unlocks better answers.",
        "base-youtube-insight": "Share a concise reaction with one useful takeaway.",
        "base-youtube-engage-question": "End with a question that invites thoughtful engagement."
      },
      createObjective: "Create objective",
      editObjective: "Edit objective",
      newObjective: "New objective",
      myStrategy: "My strategy",
      myStrategyDesc: "Your custom communication strategies.",
      deleteConfirmTitle: "Delete this objective?",
      deleteConfirmDesc: "This action is permanent and cannot be undone.",
      strategyPromptLabel: "Strategy prompt",
      descriptionOptional: "Description (optional)",
      promptMinLengthError: "The prompt must be more descriptive",
      selectPlatformError: "Select at least one platform",
      emptyObjectivesTitle: "No custom objectives yet",
      emptyObjectivesDesc: "Create your first custom objective to tailor strategy by platform.",
      deactivate: "Deactivate",
      activate: "Activate",
      remove: "Remove",
      saved: "Goals updated",
      saveError: "Could not save goals",
      platformCount: "{0} platforms",
      duplicateNameError: "This objective name already exists",
      nameRequiredError: "Objective name is required"
    },
    historyFilters: {
    ...
    historyItem: {
      ...
      copyAction: "Copy",
      feedbackRatingLabel: "Did you like it?",
      feedbackNoRating: "No feedback",
      feedbackNoteLabel: "Feedback note",
      feedbackNotePlaceholder: "Example: too generic, great opening, close was weak...",
      feedbackSaveAction: "Save feedback",
    ...
    profileForm: {
      ...
      bannedPhrasesLabel: "Banned phrases (comma separated)",
      bannedPhrasesPlaceholder: "great post, totally agree, love it",
