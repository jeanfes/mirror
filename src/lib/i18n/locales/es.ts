const es = {
  ...
  app: {
    ...
    billing: {
      ...
      creditActivityTitle: "Actividad de créditos",
      creditTransactions: "Transacciones de créditos",
      creditTransactionsDesc: "Movimientos recientes de créditos en tu cuenta.",
      planChanges: "Cambios de plan",
      planChangesDesc: "Historial de mejoras, cancelaciones y degradaciones.",
      billingSnapshot: "Resumen de facturación",
      billingSnapshotDesc: "Generaciones registradas este mes.",
      creditTransactionsEmptyTitle: "Sin transacciones de créditos",
      creditTransactionsEmptyDesc: "Cuando uses o recibas créditos, aparecerán aquí.",
      planChangesEmptyTitle: "Sin cambios de plan",
      planChangesEmptyDesc: "Los cambios entre Free y Pro aparecerán aquí.",
      creditDate: "Fecha",
      creditDelta: "Variación",
      creditBalance: "Saldo",
      creditType: "Tipo",
      planChangeDate: "Fecha",
      planChangeFrom: "Desde",
      planChangeTo: "Hacia",
