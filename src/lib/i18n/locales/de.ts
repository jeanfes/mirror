const de = {
  ...
  contactPage: {
    ...
    subjectOptions: {
      ...
      productFeedback: "Produktfeedback",
      billing: "Abrechnung",
      sales: "Vertrieb",
      other: "Sonstiges"
    },
    ...
    errors: {
      ...
      subjectRequired: "Bitte wählen Sie ein Thema aus",
  ...
  app: {
    common: {
      ...
      notFoundDesc: "Die angeforderte Route existiert in diesem Workspace nicht oder du hast keinen Zugriff.",
      notFoundGoToApp: "Zu Mirror",
      notFoundGoToLanding: "Zur Startseite",
      metadataDescription: "Intelligenter Workspace mit local-first KI.",
    ...
    settings: {
      ...
      languageBaselineTitle: "Sprache und aktives Profil",
    ...
    goals: {
      ...
      assignmentDesc: "Optional kann pro Plattform ein aktives benutzerdefiniertes Ziel zugeordnet werden. Ohne Zuordnung gilt das Basisziel.",
      ...
      objectiveDescriptionPlaceholder: "Optionale Beschreibung zur Erinnerung an die Absicht.",
      scopeLabel: "Geltungsbereich",
      scopeHelp: "Wahlen Sie eine oder mehrere Plattformen aus.",
      selectAllScope: "Alle auswahlen",
      ...
      baseObjectiveNames: {
        "base-linkedin-job-search": "Positionierung fur Jobsuche",
        "base-linkedin-networking": "Strategisches Networking",
        "base-linkedin-authority": "Autoritat mit Insights",
        "base-linkedin-conversation": "Gespracheinstieg",
        "base-linkedin-followup": "Professionelles Follow-up",
        "base-upwork-proposal": "Freelance-Angebot",
        "base-upwork-scope-discovery": "Scope-Klarung",
        "base-upwork-value-diff": "Wertdifferenzierung",
        "base-upwork-close-cta": "Abschluss mit nachstem Schritt",
        "base-upwork-objections": "Einwandbehandlung",
        "base-twitter-hot-take": "Konstruktiver Kontrapunkt",
        "base-twitter-thread-value": "Mehrwert im Thread",
        "base-reddit-context-help": "Kontextbezogene Hilfe",
        "base-reddit-question": "Klarungsfrage",
        "base-youtube-insight": "Reaktion mit Insight",
        "base-youtube-engage-question": "Frage fur Engagement"
      },
      baseObjectiveDescriptions: {
        "base-linkedin-job-search": "Baue Glaubwurdigkeit auf, um Jobchancen anzuziehen.",
        "base-linkedin-networking": "Starte authentische professionelle Gesprache und erweitere dein Netzwerk.",
        "base-linkedin-authority": "Teile praxisnahe Insights, um deine Autoritat zu starken.",
        "base-linkedin-conversation": "Offne das Gesprach mit einem klaren und naturlichen Impuls.",
        "base-linkedin-followup": "Fuhre mit einem konkreten nachsten Schritt nach.",
        "base-upwork-proposal": "Zeige Passung, Vorgehen und erwartetes Ergebnis in einem kompakten Angebot.",
        "base-upwork-scope-discovery": "Klaren Scope, Rahmenbedingungen und Erfolgskriterien fruhzeitig.",
        "base-upwork-value-diff": "Hebe hervor, was deinen Ansatz anders und wertvoll macht.",
        "base-upwork-close-cta": "Schliesse mit einer klaren nachsten Aktion fur mehr Momentum.",
        "base-upwork-objections": "Beantworte Einwande mit Belegen, Ruhe und Optionen.",
        "base-twitter-hot-take": "Bringe einen konstruktiven Kontrapunkt ein, ohne den Ton zu verscharfen.",
        "base-twitter-thread-value": "Fuge einen konkreten Insight hinzu, der den Thread weiterbringt.",
        "base-reddit-context-help": "Antworte mit Kontext und praktischer Hilfe zur ursprunglichen Frage.",
        "base-reddit-question": "Stelle eine Klarungsfrage, die bessere Antworten auslost.",
        "base-youtube-insight": "Teile eine kurze Reaktion mit einem nutzlichen Takeaway.",
        "base-youtube-engage-question": "Beende mit einer Frage, die zu hochwertigem Engagement einladt."
      },
      createObjective: "Ziel erstellen",
      editObjective: "Ziel bearbeiten",
      newObjective: "Neues Ziel",
      myStrategy: "Meine Strategie",
      myStrategyDesc: "Ihre benutzerdefinierten Kommunikationsstrategien.",
      deleteConfirmTitle: "Dieses Ziel entfernen?",
      deleteConfirmDesc: "Diese Aktion ist dauerhaft und kann nicht ruckgangig gemacht werden.",
      strategyPromptLabel: "Strategie-Prompt",
      descriptionOptional: "Beschreibung (optional)",
      promptMinLengthError: "Der Prompt muss beschreibender sein",
      selectPlatformError: "Wahlen Sie mindestens eine Plattform",
      emptyObjectivesTitle: "Noch keine benutzerdefinierten Ziele",
      emptyObjectivesDesc: "Erstellen Sie Ihr erstes benutzerdefiniertes Ziel, um die Strategie je Plattform anzupassen.",
      deactivate: "Deaktivieren",
      activate: "Aktivieren",
      remove: "Entfernen",
      saved: "Ziele aktualisiert",
      saveError: "Ziele konnten nicht gespeichert werden",
      platformCount: "{0} Plattformen",
      duplicateNameError: "Ein Ziel mit diesem Namen existiert bereits",
      nameRequiredError: "Der Zielname ist erforderlich"
    },
    historyFilters: {
