        ...
        <div className={cn("space-y-1.5", className)}>
            ...
            <SelectPrimitive.Root value={value} onValueChange={onChange}>
                <SelectPrimitive.Trigger
                    className={cn(
                        "flex h-10 w-full items-center justify-between rounded-xl border border-border-soft bg-white px-3 py-2 text-[13px] font-medium text-primary-text transition-all hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-accent-purple/30 disabled:cursor-not-allowed disabled:opacity-50",
                        triggerClassName
                    )}
                >
